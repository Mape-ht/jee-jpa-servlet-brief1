...
<title>SenForage Gestion Client</title>
</head>
<body>
	 ...
	 <!--- For Name---->
         <div class="col-sm-12">
             <div class="row">
		         ...
		         <div class="col-xs-8">
		             <input type="text" name="fname" id="fname" placeholder="Entrer votre Nom" class="form-control ">
             </div>
		      </div>
		 </div>
         ...
         <div class="col-sm-12">
		     <div class="row">
				...
				<div class ="col-xs-8">	 
		             <input type="text" name="lname" id="lname" placeholder="Entrer votre Prenom" class="form-control last">
                </div>
		     </div>
		 </div>
     <!-----For email---->
